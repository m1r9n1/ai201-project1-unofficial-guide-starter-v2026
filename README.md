...
You can add a course through the end of the second week. Dropping is a longerwindow — through the end of week six — but a drop after week two shows as a Won your transcript. Nothing anywhere on the registrar's site says this plainly, and students find out from each other.
```
...
```
The good: cheapest housing tier by about $900 a year, and the singles are real singles. fill this info in the following template highlighted
```
